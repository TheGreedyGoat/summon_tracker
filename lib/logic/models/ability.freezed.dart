...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AbilityScoreString&&(identical(other.ability, ability) || other.ability == ability)&&(identical(other.score, score) || other.score == score)&&(identical(other.proficiency, proficiency) || other.proficiency == proficiency));
}
...
@override
String toString() {
  return 'AbilityScoreString(ability: $ability, score: $score, proficiency: $proficiency)';
}
