...
part of 'edit_variant_notifier.dart';
...
abstract mixin class $EditTemplateStateCopyWith<$Res>  {
  factory $EditTemplateStateCopyWith(EditVariantState value, $Res Function(EditVariantState) _then) = _$EditTemplateStateCopyWithImpl;
@useResult
$Res call({
 String name, String armorClass, String hitPoints, String speed, String senses, String languages, String proficiencyBonus, List<DamageModifier> damageMods, List<AbilityScoreString> abilityScores, List<SkillProficiency> skillProficiencies, List<ActionFeature> featureAbilities, List<ActionFeature> actions, List<ActionFeature> bonusActions, List<ActionFeature> reactions, Map<String, String> variableState, Map<String, String> variableNames
});
...
class _$EditTemplateStateCopyWithImpl<$Res>
  ...
  final EditVariantState _self;
  final $Res Function(EditVariantState) _then;
...
/// Adds pattern-matching-related methods to [EditVariantState].
extension EditTemplateStatePatterns on EditVariantState {
