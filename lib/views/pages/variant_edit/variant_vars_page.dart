...
class VariantVarsPage extends ConsumerStatefulWidget {
  const VariantVarsPage({super.key});

  @override
  ConsumerState<VariantVarsPage> createState() => _VariantVarsPageState();
}

class _VariantVarsPageState extends ConsumerState<VariantVarsPage> {
